...
**Türkçe**
Bu repo, Fizik Tabanlı A* algoritmasını görselleştirir. **NumPy** kullanarak bir dağ oluşturur ve **Matplotlib** ile ısı haritası çizer. Rover'ın dağı tırmanmak yerine, enerji tasarrufu için etrafından dolaşmayı otonom olarak nasıl seçtiğini gösterir.
